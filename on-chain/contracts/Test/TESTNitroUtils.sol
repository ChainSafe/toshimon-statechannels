...
contract TESTNitroUtils {
    ...
    function getChannelId(INitroTypes.FixedPart memory fixedPart) public pure returns (bytes32 channelId) {
        return NitroUtils.getChannelId(fixedPart);
    }
    ...
    function hashState(
        ...
        return NitroUtils.hashState(channelId, appData, outcome, turnNum, isFinal);
    }
